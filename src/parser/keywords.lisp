...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (def-keyword-rule "timestamp")
  (def-keyword-rule "at")
  (def-keyword-rule "time")
  (def-keyword-rule "zone")
  ...
  (def-keyword-rule "count")
  (def-keyword-rule "delete")
  (def-keyword-rule "exists")
  (def-keyword-rule "extend")
  (def-keyword-rule "first")
  (def-keyword-rule "last")
  (def-keyword-rule "limit")
  (def-keyword-rule "next")
  (def-keyword-rule "prior")
  (def-keyword-rule "trim")
  (def-keyword-rule "execute")
  (def-keyword-rule "immediate"))
